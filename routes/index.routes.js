...
apptRouter.post('/',            authorize('Patient'), createAppointment);  // Patient only
...
const {
  getAllPrescriptions, getPrescriptionById, createPrescription, updatePrescription,
} = require('../controllers/prescription.controller');

rxRouter.use(authenticate);
rxRouter.get('/',      getAllPrescriptions);               // FIX: was missing
...
admitRouter.patch('/:id/discharge', dischargePatient);   // PATCH — Postman is now fixed to match
